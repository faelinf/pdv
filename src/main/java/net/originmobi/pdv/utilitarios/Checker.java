...
import net.originmobi.pdv.infra.exception.NotExistException;
...
public class Checker {
   ...
   * @throws PDVException se obj for nulo
   */
  ...
  public static <T> T notNull(final T obj, @NonNull final Supplier<MessageException> params) {
    if (obj == null) {
      throw new PDVException(params.get());
    }
    return obj;
  }
   ...
   * @param key  mensagem de erro
   * @param args Parâmetros da mensagem
   * @throws PDVException se obj não for nulo
   */
  public static void isNull(final Object obj, I18nKey key, Object... args) {
    if (obj != null) {
      throw PDVException.valueOf(key, args);
    }
  }
   ...
   * @param args  Parâmetros da mensagem
   * @return Objeto validado
   * @throws PDVException se obj for nulo ou vazio
   */
   ...
   * @param args  Parâmetros da mensagem
   * @return Objeto validado
   * @throws PDVException se obj for nulo ou em branco
   */
   ...
   * @param key   Mensagem de erro
   * @param args  Parâmetros da mensagem
   * @throws PDVException caso <b>value</b> seja <code>false</code>
   */
  ...
  public static void isTrue(final boolean value, final Supplier<MessageException> supplier) {
    if (!value) {
      throw new PDVException(supplier.get());
    }
  }
   ...
   * @param key      Mensagem de erro
   * @param args     Parâmetros da mensagem
   * @throws PDVException caso os valores não sejam iguais.
   */
   ...
   * @param key   Mensagem de erro
   * @param args  Parâmetros da mensagem
   * @throws PDVException caso <b>value</b> seja <code>true</code>
   */
   ...
   * @param args  Parâmetros da mensagem
   * @throws PDVException caso <b>value</b> não seja positivo
   */
   ...
   * @param key   Mnesagem de erro
   * @param args  Parâmetros da mensagem
   * @throws PDVException caso <b>value</b> seja negativo
   */
   ...
   * @param key   Mnesagem de erro
   * @param args  Parâmetros da mensagem
   * @throws PDVException caso <b>value</b> seja superior a agora
   */
   ...
   * @param key   Mnesagem de erro
   * @param args  Parâmetros da mensagem
   * @throws PDVException caso <b>value</b> seja inferior a agora
   */
   ...
   * @param args   Parâmetros da mensagem
   * @return Valor informado.
   * @throws PDVException caso <b>value</b> não tenha o tamanho informado
   */
   ...
   * @param args  Parâmetros da mensagem
   * @return Valor informado.
   * @throws PDVException caso <b>value</b> seja menor o mínimo informado
   */
   ...
   * @param args  Parâmetros da mensagem
   * @return Valor informado.
   * @throws PDVException caso <b>value</b> seja menor o máximo informado
   */
   ...
   * @throws PDVException caso <b>value</b> não tenha valor presente.
   */
   ...
   * @param key   Mensagem de erro
   * @param args  Parâmetro da mensagem
   * @throws PDVException caso <b>value</b> tenha valor presente.
   */
