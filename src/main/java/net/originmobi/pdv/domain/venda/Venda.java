...
public class Venda implements Serializable {
  ...
  void abrir() {
    setSituacao(VendaSituacao.ABERTA);
  }

  void fechar() {
    setSituacao(VendaSituacao.FECHADA);
  }

  void cancelar() {
    setSituacao(VendaSituacao.CANCELADA);
  }
  ...
  public void setValor_acrescimo(Double valor_acrescimo) {
    this.valor_acrescimo = valor_acrescimo != null ? valor_acrescimo : 0.0D;
  }
